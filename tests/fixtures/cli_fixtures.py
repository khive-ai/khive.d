...
def mock_khive_commands():
    ...
    with patch("importlib.import_module") as mock_import, \
         patch("khive.services.plan.planner_service.OrchestrationPlanner") as mock_planner, \
         patch("khive.services.plan.planner_service.PlannerService") as mock_service, \
         patch("khive.services.composition.agent_composer.AgentComposer") as mock_composer:
