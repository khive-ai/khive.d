...
from khive.services.info.parts import InfoRequest, InfoResponse, InsightMode, Insight, InsightSource
...
class TestInfoServiceIntegration:
    ...
    def test_service_interface_completeness(self):
        ...
        assert 'request' in params or 'query' in params  # Should accept some form of request
...
class TestInsightModeDetection:
    ...
    def test_analytical_mode_detection(self):
        ...
        for query in analytical_queries:
            ...
            analysis_keywords = ["analyze", "compare", "evaluate", "trade-offs", "implications"]
            has_analysis_keyword = any(keyword in query.lower() for keyword in analysis_keywords)
