...
class TestSchemaUtil:
    ...
    def test_successful_model_generation_from_dict(
        self, mock_module_from_spec, mock_spec_from_file, mock_generate, simple_schema_dict
    ):
    ...
    def test_successful_model_generation_from_string(
        self, mock_module_from_spec, mock_spec_from_file, mock_generate, simple_schema_str
    ):
    ...
    def test_invalid_schema_type(self):
        ...
        with patch('khive._libs.schema._HAS_DATAMODEL_CODE_GENERATOR', True):
            with pytest.raises(TypeError, match="Schema must be a JSON string or a dictionary"):
    ...
    def test_title_sanitization(self, schema_with_special_title):
        ...
        with patch('khive._libs.schema._HAS_DATAMODEL_CODE_GENERATOR', True):
            with patch('datamodel_code_generator.generate') as mock_generate:
                with patch('khive._libs.schema.importlib.util.spec_from_file_location') as mock_spec_from_file:
                    with patch('khive._libs.schema.importlib.util.module_from_spec') as mock_module_from_spec:
                        ...
                        mock_module.__dict__ = {'UserProfileModel2024': MockUserProfileModel2024}
                        ...
                        with patch('tempfile.TemporaryDirectory') as mock_temp_dir:
                            ...
                            result = SchemaUtil.load_pydantic_model_from_schema(schema_with_special_title)
    ...
    def test_missing_output_file(self, mock_generate, simple_schema_dict):
        ...
        with patch('tempfile.TemporaryDirectory') as mock_temp_dir:
            ...
            with pytest.raises(FileNotFoundError, match="Generated model file was not created"):
                SchemaUtil.load_pydantic_model_from_schema(simple_schema_dict)

    @patch('khive._libs.schema._HAS_DATAMODEL_CODE_GENERATOR', True)
    @patch('datamodel_code_generator.generate')
    @patch('khive._libs.schema.importlib.util.spec_from_file_location')
    def test_module_import_failure(self, mock_spec_from_file, mock_generate, simple_schema_dict):
    ...
    @patch('khive._libs.schema.importlib.util.spec_from_file_location')
    @patch('khive._libs.schema.importlib.util.module_from_spec')
    def test_missing_model_class(self, mock_module_from_spec, mock_spec_from_file, mock_generate, simple_schema_dict):
        ...
        with patch('tempfile.TemporaryDirectory') as mock_temp_dir:
            ...
            with pytest.raises(AttributeError, match="Could not find expected model class"):
                SchemaUtil.load_pydantic_model_from_schema(simple_schema_dict)
    ...
    @patch('khive._libs.schema.importlib.util.spec_from_file_location')
    @patch('khive._libs.schema.importlib.util.module_from_spec')
    def test_model_rebuild_failure(self, mock_module_from_spec, mock_spec_from_file, mock_generate, simple_schema_dict):
