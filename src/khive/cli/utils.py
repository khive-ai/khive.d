...
def log_msg_commit(msg: str, *, kind: str = "B") -> None:
    """Legacy compatibility wrapper."""
    log_msg(msg, kind=kind)
...
def format_message_commit(prefix: str, msg: str, color_code: str) -> str:
    """Legacy compatibility wrapper."""
    return format_message(prefix, msg, color_code)
...
def info_msg_commit(msg: str, *, console: bool = True) -> str:
    """Legacy compatibility wrapper."""
    return info_msg(msg, console=console)
...
def warn_msg_commit(msg: str, *, console: bool = True) -> str:
    """Legacy compatibility wrapper."""
    return warn_msg(msg, console=console)
...
def error_msg_commit(msg: str, *, console: bool = True) -> str:
    """Legacy compatibility wrapper."""
    return error_msg(msg, console=console)
...
def die_commit(
    ...
    """Legacy compatibility wrapper."""
    die(msg, json_data, json_output_flag)
