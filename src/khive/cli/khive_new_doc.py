...
class NewDocCommand(ConfigurableCLICommand):
    ...
    def _add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        deliverable = subparsers.add_parser(
            "deliverable", help="Create agent deliverable"
        )
        deliverable.add_argument(
            "--agent", required=True, help="Agent ID (e.g., researcher_memory-systems)"
        )
        deliverable.add_argument(
            "--coordination", required=True, help="Coordination ID from khive plan"
        )
        deliverable.add_argument(
            "--phase",
            required=True,
        ...
        deliverable.add_argument(
            "--name", help="Document name (default: AGENT_PHASE_final)"
        )

        # Artifact subcommand (for general docs)
        artifact = subparsers.add_parser("artifact", help="Create artifact document")
        artifact.add_argument("name", help="Document name")
        artifact.add_argument("--coordination", required=True, help="Coordination ID")
    ...
    def _list_templates(self, config: NewDocConfig) -> CLIResult:
        ...
        return CLIResult(
            status="success", message=message, data={"templates": templates}
        )
...
def main():
    ...
    # Deliverable subcommand (for agents)
    deliverable = subparsers.add_parser("deliverable", help="Create agent deliverable")
    deliverable.add_argument(
        "--agent", required=True, help="Agent ID (e.g., researcher_memory-systems)"
    )
    deliverable.add_argument(
